$(function(){
    ...
    $("#bookQuery_button").click(function (){
        var bookName=$("#book_name").val();
        pageInit(bookName);
    });

    function pageInit(bookName){

        $.getJSON(countURL,{bookName:bookName},function (result){
            if (result.success){
    ...
    function pageInfo(curPage,bookName){
        alert(curPage);
        $.getJSON(recomURL,{pageIndex:curPage,pageSize:4,bookName:bookName},function(result){
